...
URL = f"https://app.thestorygraph.com/currently-reading/{USERNAME}"

def main() -> None:
    """Main function to fetch and save currently reading books."""
    load_dotenv()
    ...
    try:
        ...
        books = parse_books(driver.page_source, extract_date=False)
        for book in books:
            save_book(book, BOOKS_DIR, currently_reading=True)
